...
const MyComponent = () => {
  ...
  return (
    <div>
      ...
      <img src={process.env.PUBLIC_URL + '/img/assistente5.png'} alt="balao-chatbot" className='logo-img' style={{ width: '65px', height: '65px', cursor: 'pointer',  marginRight: '6px', marginTop: '-20px' }} />
